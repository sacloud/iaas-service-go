...
import (
	...
	service "github.com/sacloud/sacloud-go/service/iaas"
...
type dummyDiskBuilder struct {
	result       *diskBuilder.BuildResult
	updateResult *diskBuilder.UpdateResult
	diskID       types.ID
...
func (d *dummyDiskBuilder) Build(ctx context.Context, zone string, serverID types.ID) (*diskBuilder.BuildResult, error) {
	if d.err != nil {
		return nil, d.err
	}
	return d.result, nil
...
// Update ディスクの更新
func (d *dummyDiskBuilder) Update(ctx context.Context, zone string) (*diskBuilder.UpdateResult, error) {
	if d.err != nil {
		return nil, d.err
	}
		...
		Updates: []*testutil.CRUDTestFunc{
			{
				Func: func(ctx *testutil.CRUDTestContext, caller iaas.APICaller) (interface{}, error) {
					...
					blackboxBuilder.DiskBuilders = append(blackboxBuilder.DiskBuilders, &diskBuilder.BlankBuilder{
						...
						Client:      diskBuilder.NewBuildersAPIClient(testutil.SingletonAPICaller()),
					})
