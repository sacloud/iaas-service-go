module github.com/sacloud/sacloud-go/service/iaas

go 1.17

replace (
	github.com/sacloud/sacloud-go => ../..
	github.com/sacloud/sacloud-go/pkg => ../../pkg
)

require (
	github.com/sacloud/ftps v1.1.0
	github.com/sacloud/iaas-api-go v0.0.0-20220314063652-5eaa6e6cade6
	github.com/sacloud/sacloud-go v0.0.0-00010101000000-000000000000
